...
public class SnappingTurtle extends AquaticAnimal implements AnimalDescription {
    ...
    public SnappingTurtle(String name, String adress, Date arrivalDate, Date dateOfBirth, AnimalDescription description, boolean adopted, int age, String bloodType) {
